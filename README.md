...
2. Run stereo camera calibration: ```calibrate.ipynb ```. Change constants to your specific ones.
...
1. Create your own camera calibration files (refer to ```calibrate.ipynb ```)
